...
class Rpc_UrlConfigNotic {
    ...
    private static $config = array(
        ...
        'N002' => array(
            ...
            'method' => 'getTagList',
            'auth' => true,
            'url' => '/GroupNoticeTag/getAdminTagList',
            'param' => array(
                'groupid' => array(
                    'required' => true,
                    'format' => 'int',
        ...
        'N004' => array(
            ...
            'auth' => true,
            'url' => '/GroupNoticeTag/updateNoticeTagById',
            'param' => array(
                'id' => array(
                    'required' => true,
                    'format' => 'int',
        ...
        'N005' => array(
            ...
            'method' => 'addTagInfo',
            'auth' => true,
            'url' => '/GroupNoticeTag/addNoticeTag',
            'param' => array(
                'groupid' => array(
                    'required' => true,
                    'format' => 'int',
        ...
        'N006' => array(
            ...
            'method' => 'get',
            'auth' => true,
            'url' => '/GroupNotice/updatenoticbyid',
            'param' => array(
                'id' => array(
                    'required' => true,
                    'format' => 'int',
